  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 pb-32 md:pb-8 sm:mt-5">
      ...
      >
        ...
        <div className="flex md:hidden items-center justify-between p-4 sticky top-0 bg-gradient-to-b from-white/95 to-white/80 dark:from-gray-900/95 dark:to-gray-900/80 backdrop-blur-md z-10 shadow-sm border-b border-gray-100 dark:border-gray-800">
          <button
            onClick={() => router.back()}
            className="p-2.5 -ml-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-800 transition-all duration-200 active:scale-95"
          >
          ...
          <div className="flex gap-1.5">
            <button
              onClick={handleShare}
              className="p-2.5 rounded-full hover:bg-gray-200 dark:hover:bg-gray-800 active:scale-95 transition-all duration-200"
              title="Copy product link"
            >
              <Share2 size={24} className="text-gray-700 dark:text-gray-200" />
            </button>
          </div>
        </div>
        {product && (
          <div className="max-w-7xl mx-auto sm:mt-10 px-0 md:px-8 md:py-8">
            <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
              {/* --- LEFT: Image Gallery --- */}
              <div className="w-full md:w-1/2 space-y-4">
                <motion.div
                  layoutId={`product-image-${product.id}`}
                  className="relative w-full aspect-square md:aspect-4/3 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 md:rounded-3xl overflow-hidden shadow-lg"
                >
              ...
              <div className="w-full md:w-1/2 px-4 md:px-0 space-y-6">
                ...
                <motion.div
                  ...
                  className="p-6 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-gray-800/50 dark:to-gray-800/30 rounded-3xl border-2 border-yellow-200 dark:border-yellow-900/20 flex items-center justify-between shadow-sm hover:shadow-md transition-shadow"
                >
                  <div>
                  ...
                  <div className="flex items-center gap-2 bg-white dark:bg-gray-700 rounded-2xl p-2 shadow-lg border border-gray-200 dark:border-gray-600">
                    <motion.button
                      ...
                      className="w-11 h-11 flex items-center justify-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors disabled:opacity-50 text-gray-600 dark:text-gray-300"
                      disabled={quantity <= 1}
                    >
                      <Minus size={18} />
                    </motion.button>
                    ...
                    <motion.button
                      whileTap={{ scale: 0.95 }}
                      onClick={() => handleQuantityChange(quantity + 1)}
                      className="w-11 h-11 flex items-center justify-center rounded-lg bg-gradient-to-br from-yellow-500 to-orange-500 text-white shadow-lg shadow-yellow-500/30 hover:shadow-xl hover:shadow-yellow-500/40 transition-all active:scale-95"
                    >
                      <Plus size={18} />
                    </motion.button>
                  </div>
                ...
                <div className="fixed md:static bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-white via-white to-white/95 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900/95 border-t border-gray-200 dark:border-gray-800 md:border-none md:p-0 md:bg-transparent z-20 shadow-2xl md:shadow-none">
                  <div className="flex gap-3 max-w-7xl mx-auto">
                    <motion.button
                      whileTap={{ scale: 0.95 }}
                      onClick={() => toggleWishlist(product.id.toString())}
                      className="md:hidden p-4 rounded-2xl border-2 border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 shrink-0 hover:border-red-300 dark:hover:border-red-700 transition-colors"
                    >
                      <Heart
                        size={24}
