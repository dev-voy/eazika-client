...
const DeleteConfirmationModal = ({ 
    ...
    >
        ...
        >
            ...
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Delete Address?</h2>
    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                {/* Tag Selection */}
                <div>
                    <label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2 block">Label</label>
                ...
                {!isEditing && (
                    ...
                    >
                        {isLocating ? <Loader2 className="animate-spin w-4 h-4" /> : <Crosshair className="w-4 h-4" />}
                ...
                <div className="flex gap-3 pt-4">
                    ...
                    >
                        {isSaving ? <Loader2 className="animate-spin w-5 h-5" /> : "Save Address"}
                    </button>
                </div>
            </form>
        </motion.div>
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-24">
            ...
            <header className="sticky top-0 z-10 px-4 py-4 flex items-center gap-3 bg-gray-50/80 dark:bg-gray-900/80 backdrop-blur-md">
                <button 
                    onClick={() => viewState === 'form' ? setViewState('list') : router.back()} 
                ...
                <h1 className="text-xl font-bold text-gray-900 dark:text-white">
                    {viewState === 'form' ? (editingAddress ? 'Edit Address' : 'New Address') : 'My Addresses'}
                </h1>
            </header>
                        ...
                        >
                            {addresses.length === 0 ? (
                                <div className="text-center py-20">
                                    ...
                                    <h2 className="text-lg font-bold text-gray-900 dark:text-white">No addresses yet</h2>
                                            ...
                                            <div className="flex justify-between items-start">
                                                <div className="flex gap-4">
                                                    <div className="w-10 h-10 rounded-full bg-gray-50 dark:bg-gray-700 flex items-center justify-center shrink-0">
                                                        {address.name.toLowerCase() === 'work' ? <Briefcase size={18} /> : <Home size={18} />}
                                                    </div>
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-gray-500 mt-2 font-medium">Phone: {address.phone}</p>
                                                    </div>
                                                </div>
