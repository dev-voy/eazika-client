...
export default function ShopRegistrationContent() {
  ...
  const normalizeDocuments = (
    ...
    businessCertificateImage:
      docs?.businessCertificateImage ??
      DEFAULT_DOCUMENTS.businessCertificateImage,
  ...
  useEffect(() => {
    ...
    const savedData =
      typeof window !== "undefined"
        ? localStorage.getItem("shopRegData")
        : null;
  ...
  type NestedKey<S extends NestedSection> = keyof NonNullable<
    CreateShopPayload[S]
  >;
  ...
  const handleUseCurrentLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        ...
        toast.warning(
          "Location permission denied. You can continue without it.",
        );
        setIsLoading(false);
      },
    );
              ...
              >
                ...
                <motion.div
                  ...
                  animate={{
                    ...
                    backgroundColor:
                      isActive || isCompleted ? "#eab308" : "#ffffff",
                    borderColor:
                      isActive || isCompleted ? "#eab308" : "#d1d5db",
                  }}
                  className={cn(
              ...
              >
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    />
                    <p className="text-[10px] text-gray-500 dark:text-gray-400">
                      This uses your login mobile number and cannot be edited
                      here.
                    </p>
                  </div>
                </div>
