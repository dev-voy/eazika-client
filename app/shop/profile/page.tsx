...
export default function ShopProfilePage() {
    ...
    const [activeTab, setActiveTab] = useState<'details' | 'bank' | 'documents'>('details');
    ...
    const updateNestedField = (section: 'bankDetail', field: string, value: string) => {
        setFormData(prev => ({
            ...prev,
    ...
    if (isLoading) return <div className="flex h-screen items-center justify-center"><Loader2 className="animate-spin text-yellow-500" size={32} /></div>;
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm relative overflow-hidden">
                ...
                <div className="relative flex flex-col md:flex-row items-center gap-6 mt-4">
                    ...
                    <div className="text-center md:text-left flex-1">
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{profile.shopName}</h1>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm min-h-[400px]">
                <AnimatePresence mode="wait">
                    ...
                    {activeTab === 'details' && (
                        ...
                        >
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="font-bold text-lg text-gray-900 dark:text-white">Business Information</h3>
                                <button 
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-bold text-gray-500 uppercase">FSSAI License</label>
                                    <input 
                                        disabled={!isEditing}
                    ...
                    {activeTab === 'bank' && (
                         ...
                         >
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="font-bold text-lg text-gray-900 dark:text-white">Bank Details</h3>
                                <button 
                                    onClick={() => isEditing ? handleSave() : setIsEditing(true)}
                                    className={`px-4 py-2 rounded-xl font-bold text-sm flex items-center gap-2 transition-colors ${
                                        isEditing ? 'bg-green-500 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'
                                    }`}
                                >
                            ...
                            <div className="bg-yellow-50 dark:bg-yellow-900/10 p-4 rounded-xl border border-yellow-100 dark:border-yellow-900/30 flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-gray-900 dark:text-white">Secure Payouts</p>
                                    <p className="text-xs text-gray-500 dark:text-gray-400">Payments are processed to this account every Wednesday.</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        onChange={(e) => updateNestedField('bankDetail', 'accountHolderName', e.target.value)}
                                        className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-xl disabled:opacity-60 disabled:cursor-not-allowed outline-none focus:border-yellow-500"
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        onChange={(e) => updateNestedField('bankDetail', 'accountNumber', e.target.value)}
                                        className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-xl disabled:opacity-60 disabled:cursor-not-allowed outline-none focus:border-yellow-500"
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        onChange={(e) => updateNestedField('bankDetail', 'ifscCode', e.target.value)}
                                        className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-xl disabled:opacity-60 disabled:cursor-not-allowed outline-none focus:border-yellow-500 uppercase"
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        onChange={(e) => updateNestedField('bankDetail', 'bankName', e.target.value)}
                                        className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-xl disabled:opacity-60 disabled:cursor-not-allowed outline-none focus:border-yellow-500"
                                    />
                                </div>
                            </div>
                    ...
                    {activeTab === 'documents' && (
                        <motion.div 
                            ...
                            className="space-y-6"
                        >
                            <h3 className="font-bold text-lg text-gray-900 dark:text-white mb-4">Uploaded Documents</h3>
                            
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {profile.documents && Object.entries(profile.documents).map(([key, url]) => (
                                    <div key={key} className="relative aspect-3/4 bg-gray-100 dark:bg-gray-900 rounded-xl overflow-hidden group border border-gray-200 dark:border-gray-700">
                                        <Image src={url} alt={key} layout="fill" objectFit="cover" className="group-hover:scale-105 transition-transform" />
                                        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                            <span className="text-white text-xs font-bold mb-2 uppercase">{key.replace('Image', '')}</span>
