...
import { shopService, type ShopOrder } from "@/services/shopService";
            ...
            >
              <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm hover:border-yellow-500/50 transition-all group cursor-pointer">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span
                    className={`flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${getStatusColor(
                      order.status
                    )}`}
                  >
